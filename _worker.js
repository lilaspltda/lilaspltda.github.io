...
// .svelte-kit/output/server/chunks/index-b1f1dce4.js
function noop() {
}
function run(fn) {
  return fn();
  ...
  ".svelte-kit/output/server/entries/pages/__layout.svelte.js"() {
	...
	<nav class="${"svelte-t2wq17"}"><svg viewBox="${"0 0 2 3"}" aria-hidden="${"true"}" class="${"svelte-t2wq17"}"><path d="${"M0,0 L1,2 C1.5,3 1.5,3 2,3 L2,0 Z"}" class="${"svelte-t2wq17"}"></path></svg>
		<ul class="${"svelte-t2wq17"}"><li class="${["svelte-t2wq17", $page.url.pathname === "/" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/"}" class="${"svelte-t2wq17"}">Home</a></li>
			<li class="${["svelte-t2wq17", $page.url.pathname === "/about" ? "active" : ""].join(" ").trim()}"><a sveltekit:prefetch href="${"/about"}" class="${"svelte-t2wq17"}">About</a></li></ul>
...
var init__ = __esm({
  ".svelte-kit/output/server/nodes/0.js"() {
    init_layout_svelte();
    index = 0;
    entry = "pages/__layout.svelte-2127e279.js";
    js = ["pages/__layout.svelte-2127e279.js", "chunks/index-a6b0a6eb.js"];
...
var init__2 = __esm({
  ".svelte-kit/output/server/nodes/1.js"() {
    init_error_svelte();
    index2 = 1;
    entry2 = "error.svelte-a4cbd2c6.js";
    js2 = ["error.svelte-a4cbd2c6.js", "chunks/index-a6b0a6eb.js"];
    css3 = [];
  }
});
...
function devalue(value) {
  ...
  Array.from(counts).filter(function(entry3) {
    ...
    return b[1] - a2[1];
  }).forEach(function(entry3, i) {
    names.set(entry3[0], getName(i));
  });
...
var Server = class {
  ...
  async respond(request, options = {}) {
    ...
    if (!this.options.hooks) {
      const module = await Promise.resolve().then(() => (init_hooks_93fa095d(), hooks_93fa095d_exports));
      this.options.hooks = {
...
var manifest = {
  ...
  _: {
    entry: { "file": "start-a19e3196.js", "js": ["start-a19e3196.js", "chunks/index-a6b0a6eb.js", "chunks/index-6491635c.js"], "css": [] },
    nodes: [
